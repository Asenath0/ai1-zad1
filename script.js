...
const renderCurrentWeather = (data) => {
    ...
    attributesContainer.appendChild(renderIconAttribute('temperature', `${temperature}°C`));
    attributesContainer.appendChild(renderIconAttribute('wind', `${windSpeed}m/s`));
    attributesContainer.appendChild(renderIconAttribute('humidity', `${humidity}%`));
...
const renderForecast = (data) => {
    ...
    data.list.map(item => forecastContainer.appendChild(renderForecastItem(item)));
